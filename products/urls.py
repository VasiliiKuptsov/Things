...
from products.views import ProductListView, ProductDetailView, ProductCreateView, ProductUpdateView, ProductDeleteView, ProductCategoryListView, SearchProductsView
...
urlpatterns = [
    ...
    path("products_search/", SearchProductsView.as_view(),name="products_search"),
